...
import useCategoryCardEditionState from "../../../hooks/useCategoryCardEditionState";
import './styles.css';

const CSS_HANDLES = [
  'cardEdition__formContainer',
  'cardEdition__dateContainer'
]

export default function CategoryCardEdition({boxInformation, setRefetchData}: CategoryCardEditionProps) {
  ...
  const {
    ...
    updateFinalDate,
    handleSubmit
  } = useCategoryCardEditionState({boxInformation, setRefetchData});
  ...
  return(
    <div>
      ...
      >
        <div className={handles.cardEdition__formContainer}>
          {/* NOMBRE CATEGORIA */}
          <Input
          ...
          />
          <div className={handles.cardEdition__dateContainer}>
            {/* FECHA Y HORA INICIO */}
            <label>
